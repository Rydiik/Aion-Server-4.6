...
if (isset($_POST['submit'])) {
    if (isset($_POST['dbhost']) && isset($_POST['dbuser']) && isset($_POST['dbpassword']) && isset($_POST['gs']) && isset($_POST['ls']) && isset($_POST['server']) && isset($_POST['portgame']) && isset($_POST['portlogin']) && isset($_POST['timeout']) && isset($_POST['address']) && isset($_POST['dbnews']) && isset($_POST['news_amt']) && isset($_POST['access_level']) && isset($_POST['rate_exp']) && isset($_POST['rate_kinah']) && isset($_POST['rate_drop']) && isset($_POST['rate_quest'])&& isset($_POST['rev_ver']) && isset($_POST['rev_src'])) {
        $config = array('dbhost' => $_POST['dbhost'], 'dbuser' => $_POST['dbuser'], 'dbpassword' => $_POST['dbpassword'], 'gs' => $_POST['gs'], 'ls' => $_POST['ls'], 'server' => $_POST['server'], 'portgame' => $_POST['portgame'], 'portlogin' => $_POST['portlogin'], 'timeout' => $_POST['timeout'], 'address' => $_POST['address'], 'dbnews' => $_POST['dbnews'], 'news_amt' => $_POST['news_amt'], 'access_level' => $_POST['access_level'], 'member_ship_premium' => $_POST['member_ship_premium'], 'member_ship_vip' => $_POST['member_ship_vip'], 'day' => $_POST['day'], 'rate_exp' => $_POST['rate_exp'], 'rate_kinah' => $_POST['rate_kinah'], 'rate_drop' => $_POST['rate_drop'], 'rate_quest' => $_POST['rate_quest'], 'rate_m1' => $_POST['rate_m1'], 'rate_m2' => $_POST['rate_m2'], 'rate_m3' => $_POST['rate_m2'], 'rate_m4' => $_POST['rate_m4'], 'rate_m5' => $_POST['rate_m5'],'rev_ver' => $_POST['rev_ver'],'rev_src' => $_POST['rev_src']);
...
<form method="POST" action="admin.php?mod=setting">
	...
	<table align="center">
		...
		<tr>
			<td colspan="2" align="center"><b>Information about the Rates for Mobs (MaxHP & Power)</b><div class="hr"></div></td>
		</tr>
		<tr>
			<td><input type="text" name="rate_m1" value="' . $rate_m1 . '" /></td>
			<td>Junk Mob Rate</td>
		</tr>
		<tr>
			<td><input type="text" name="rate_m2" value="' . $rate_m2 . '" /></td>
			<td>Normal Mob Rate</td>
		</tr>
		<tr>
			<td><input type="text" name="rate_m3" value="' . $rate_m3 . '" /></td>
			<td>Elite Mob Rate</td>
		</tr>
		<tr>
			<td><input type="text" name="rate_m4" value="' . $rate_m4 . '" /></td>
			<td>Hero Mob Rate</td>
		</tr>
		<tr>
			<td><input type="text" name="rate_m5" value="' . $rate_m5 . '" /></td>
			<td>Legendary Mob Rate</td>
		</tr>
		...
		<tr>
			<td colspan="2" align="center"><b>Web version info</b><div class="hr"></div></td>
		</tr>
		<tr>
			<td><input type="text" name="rev_ver" value="' . $rev_ver . '" /></td>
			<td>Web script version</td>
		</tr>
		<tr>
			<td><input type="text" name="rev_src" value="' . $rev_src . '" /></td>
