...
<div class="case">
	<div class="content">
		<div class="list">
			<div class="news-title">Account Information</div>
				<!-- Block Overview -->
				<div class="menu-button border shadow" ><center><b>General Information</b></center>
					<?php require 'modules/account/account_info.php';?>
				</div>
				<!-- Block List -->
				<div class="menu-button border shadow" ><center><b>Characters List</b></center>
